(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@material-ui/core'), require('clsx')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@material-ui/core', 'clsx'], factory) :
  (global = global || self, factory(global.muiSleazebox = {}, global.react, global.core, global.clsx));
}(this, (function (exports, React, core, clsx) {
  ...
  */
  ...
  var useEnhancedFlexProp = function useEnhancedFlexProp(flexProp) {
    var flex = React.useMemo(function () {
      switch (flexProp) {
        case true:
          return 'auto';
        // Or '1 1 auto'
  ...
  var useRowBoxStyles = core.makeStyles(function (theme) {
  ...
  var useColBoxStyles = core.makeStyles(function (theme) {
    return core.createStyles({
  ...
  var EnhancedBox = function EnhancedBox(_ref5) {
    ...
    return /*#__PURE__*/React__default.createElement(core.Box, _extends({
      flex: flex
    }, rest), children);
  };
  ...
  var FlexBox = function FlexBox(_ref6) {
    ...
    return /*#__PURE__*/React__default.createElement(EnhancedBox, _extends({
      display: "flex",
  ...
  var RowBox = function RowBox(_ref8) {
    ...
    var respBreakAt = React.useMemo(function () {
    ...
    var respElseAt = React.useMemo(function () {
  ...
  exports.ChildBox = ChildBox;
  exports.ColumnBox = ColumnBox;
  exports.FlexBox = FlexBox;
  exports.RowBox = RowBox;
